...
Easing is a control for the velocity of an animation over it’s duration. Timing relates to how long that animation lasts. These two variables make up web animation control in radial. Currently, there are three tokens in Radial for easing, outlined below.
 ...
 <img alt="outgoing easing example" src="/assets/images/outgoing-animation.png" width="400" />

  #### Example: Slide out animation used in banners for dismissal.

 <img alt="Slide Out animation" src="/assets/images/Foundations-Animation-slide-out.gif" width="200" />
  ...
  <img alt="incoming easing example" src="/assets/images/incoming-animation.png" width="400" />

  #### Example: Pop up animation used for banners or lazy-loading content.

 <img alt="pop up animation" src="/assets/images/Foundations-Animation-pop-up.gif" width="200" />
 ...
 <img alt="standard easing example" src="/assets/images/standard-animation.png" width="400" />

  #### Example: Color transition animation used as a hover state for buttons. Can express brand colors.


 <img alt="color transition animation" src="/assets/images/Foundations-Animation-color-transition.gif" width="200" />
