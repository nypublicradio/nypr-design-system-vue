...
- List with featured card — 1 large vertical [cards](https://storybook.nypr.digital/latest/index.html?path=/docs/components-molecules-cards), 4 small horizontal [cards](https://storybook.nypr.digital/latest/index.html?path=/docs/components-molecules-cards)	
