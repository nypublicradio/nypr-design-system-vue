...
**Spacing Examples**
<img
    alt="Card Component demonstrating spacing between text elements"
    src="./images/Foundations-Spacing-DefaultSpacingExample.png"
    width="579"
/>

<Canvas>
    <Story name="VSpacer Examples">
        {{
            components: { VSpacer },
            template: `
<div>
    ...
    <v-spacer
      size="half"
      class="u-background-color--cool-white"
    />
    <p class="u-space--top u-space--bottom">
      Default:
    </p>
    <v-spacer class="u-background-color--cool-white" />
    <p class="u-space--top">
      Double:
    </p>
    <v-spacer
