...
<img alt="Gothamist Article Page" src="./images/Templates-Article-Gothamist.png" width="500" style="border: 2px solid #EAEFF0;filter: drop-shadow(0px 4px 8px rgba(0, 0, 0, 0.15));border-radius: 3px"/>  
