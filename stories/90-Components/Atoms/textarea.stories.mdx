...
<Meta title="Components/Atoms/Text Area" />
...
<img
    alt="example of textarea anatomy"
    src="./images/Molecules-TextArea-Anatomy.png"
    width="400"
/>
...
<img
    alt="example of default textarea"
    src="./images/Molecules-TextArea-DefaultState.png"
    width="300"
/>
<br /><br />
...
<img
    alt="example of active textarea"
    src="./images/Molecules-TextArea-ActiveState.png"
    width="300"
/>
<br /><br />
...
<img
    alt="example of required textarea"
    src="./images/Molecules-TextArea-RequiredState.png"
    width="300"
/>
  <br /><br />
...
<img
    alt="example of error textarea"
    src="./images/Molecules-TextArea-ErrorState.png"
    width="300"
/>
  <br /><br />
...
<img
    alt="example of diabled textarea"
    src="./images/Molecules-TextArea-DisabledState.png"
    width="300"
/>
        ...
        {{
            ...
            template: `
                <label>Textarea with Character Count
                    <textarea v-model="textarea" placeholder="placeholder text"/>
                    <p :class="{'error': maxCharacters-textarea.length < 0}">{{ maxCharacters-textarea.length }} Characters Remaining</p>
                </label>
            `
        }}
    </Story>
...
<Canvas>
    <Story name="Required">
        {{
            template: `
                <label class="required">Required Textarea
                    <textarea placeholder="placeholder text" required aria-required="true"/>
                </label>
            `
        }}
    </Story>
...
<Canvas>
    <Story name="Error">
        {{
            template: `
                <label class="error">Error Textarea
                    <textarea placeholder="placeholder text"/>
...
<Canvas>
    <Story name="Error with Character Counter">
        {{
            data: () => ({
                textarea: '',
                maxCharacters: 10,
            ...
            template: `
                <label class="error">Textarea with Character Count
                    <textarea v-model="textarea" placeholder="placeholder text"/>
                    <p class="error">Error text lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                    <p :class="{'error': maxCharacters-textarea.length < 0}">{{ maxCharacters-textarea.length }} Characters Remaining</p>
                </label>
...
<Canvas>
    <Story name="Disabled">
        {{
            template: `
                <label class="disabled">Disabled Textarea
                    <textarea placeholder="placeholder text" disabled aria-disabled="true"/>
                </label>
            `
        }}
    </Story>
