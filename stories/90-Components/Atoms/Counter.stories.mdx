...
## What’s Inside
<br/>
 <img alt="example of counter anatomy" src="/assets/images/Atom-Counter-Anatomy.png" width="100" />
...
When used, icons should always appear to the left of the value and text to the right of the value. This ensures that visual language always reads correctly left to right.
 <img alt="example of counter configurations" src="/assets/images/Atom-Counter-Configurations.png" width="300" />
...
<img alt="example of counter configurations2" src="/assets/images/Atom-Counter-Accessibility.png" width="300" />
<br/>
