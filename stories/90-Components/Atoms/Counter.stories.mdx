...
<Canvas>
    <Story name="Comments">
        {{
            components: { VCounter },
            template: `<v-counter icon="comment" text="Comments" value="40" href="http://www.google.com"/>`
        }}
    </Story>
</Canvas>
...
<Canvas>
    <Story name="NoIcon">
        {{
            components: { VCounter },
            template: `<v-counter text="Comments" value="40" href="http://www.google.com"/>`
        }}
    </Story>
</Canvas>
...
<Canvas>
    <Story name="NoText">
        {{
            components: { VCounter },
            template: `<v-counter icon="comment" value="40" href="http://www.google.com"/>`
        }}
    </Story>
</Canvas>
