...
In the default state, the user has not yet interacted with the link. The link is active and patiently waiting to be clicked.
 <img alt="example of default link" src="/assets/images/Atoms-Links-DefaultState.png" width="75" />
  <br/>
...
<img alt="example of hover link" src="/assets/images/Atoms-Links-HoverState.png" width="75" />
  <br/>
...
<img alt="example of disabled link" src="/assets/images/Atoms-Links-DisabledState.png" width="75" />
  <br/>
...
<img alt="example of a visited link" src="/assets/images/Atoms-Links-VisitedState.png" width="75" />
  <br/>
