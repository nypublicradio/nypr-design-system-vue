...
<img
    alt="Cropped Images"
    src="./images/Atom-Images-CroppedImages.jpg"
    width="300"
/>
...
### 1:1 Ratio Container
**1:1 Ratio Horizontal**

<Canvas>
    <Story name="1:1 Ratio Horizontal">
        {{
            template: `
            <div class="l-container l-container--10col">
              <div class="u-image__1x1">
                 <img src="https://cdn.cms.demo.nypr.digital/images/dog_f1fMIoF.2e16d0ba.fill-800x533.jpg" alt="placeholder image"/>
              </div>
            </div>
            `
        }}
...
**1:1 Ratio Horizontal - Cropped To Fit**

<Canvas>
    <Story name="1:1 Ratio Horizontal Cropped To Fit">
        {{
            template: `
            <div class="l-container l-container--10col">
              <div class="u-image__1x1 u-image__crop">
                 <img src="https://cdn.cms.demo.nypr.digital/images/dog_f1fMIoF.2e16d0ba.fill-800x533.jpg" alt="placeholder image"/>
              </div>
            </div>
            `
...
<Canvas>
    <Story name="1:1 Ratio Vertical">
        {{
            template: `
            <div class="l-container l-container--10col">
              <div class="u-image__1x1">
                 <img src="https://cdn.cms.demo.nypr.digital/images/hans_hemmert_06.2e16d0ba.fill-634x812.jpg" alt="placeholder image"/>
              </div>
            </div>
            `
        }}
...
**1:1 Ratio Vertical - Cropped To Fit**

<Canvas>
    <Story name="1:1 Ratio Vertical Cropped To Fit">
        {{
            template: `
            <div class="l-container l-container--10col">
              <div class="u-image__1x1 u-image__crop">
...
<Canvas>
    <Story name="4:3 Ratio Horizontal">
        {{
            template: `
            <div class="l-container l-container--10col">
              <div class="u-image__4x3">
                 <img src="https://cdn.cms.demo.nypr.digital/images/dog_f1fMIoF.2e16d0ba.fill-800x533.jpg" alt="placeholder image"/>
              </div>
            </div>
            `
...
**4:3 Ratio Horizontal - Cropped To Fit**

<Canvas>
    <Story name="4:3 Ratio Horizontal Cropped To Fit">
        {{
            template: `
            <div class="l-container l-container--10col">
              <div class="u-image__4x3 u-image__crop">
                 <img src="https://cdn.cms.demo.nypr.digital/images/dog_f1fMIoF.2e16d0ba.fill-800x533.jpg" alt="placeholder image"/>
              </div>
            </div>
            `
...
**4:3 Ratio Vertical - Cropped To Fit**

<Canvas>
    <Story name="4:3 Ratio Vertical Cropped To Fit">
        {{
            template: `
            <div class="l-container l-container--10col">
              <div class="u-image__4x3 u-image__crop">
