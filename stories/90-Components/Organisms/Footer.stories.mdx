...
<Canvas>
    ...
    <the-footer
      ...
      :legal-nav="[
        ...
        {
          url: 'https://www.wnyc.org/privacy',
          text: 'Privacy Policy',
          newWindow: true
        },
        {
          url: 'https://media.wnyc.org/media/resources/2020/Oct/30/accessibility_policy_10.30.20.pdf',
          text: 'Accessibility',
          newWindow: true
        }
      ]"
