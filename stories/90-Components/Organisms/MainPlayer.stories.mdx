...
3- **Program Time** - Lists the start and end time of the program currently on air. Uses the timestamp component. This element is optional and would not be used when displaying on-demand audio.
