...
## States
The most important indicator between our played and paused state is the Play/Pause button. Use icons accordingly indicate if a stream is playing or not.
