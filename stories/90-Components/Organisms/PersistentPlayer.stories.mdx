...
![enter image description here](https://via.placeholder.com/300)
...
8- **Image** - Optional image for show art
...
### Persistent Player - Desktop - Tool Tip
![enter image description here](https://via.placeholder.com/150)
State description here.
...
### Tooltip
When the user selects to view secondary data about a list item (e.g., track or segment), the Drawer Menu should subtly fade and expand in. When the user clicks to close the Drawer Menu, it should subtly fade and detract out.
...
-   If a track or segment has secondary information in the Drawer Menu, then on hover, the mouse state should signal to the user that the Drawer Menu is clickable
...
(Insert Jukebox Persistent Player Image Here)
