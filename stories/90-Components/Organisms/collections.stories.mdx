...
import VCollection from '../../../src/components/VCollection';
...
<Canvas>
    <Story name="A Collection of Small Cards">
        {{
            components: { VCard, VCollection },
            template: `
<v-collection title="A Collection of Small Cards">
<v-card
