 ...
 <img alt="card anatomy" src="./images/Molecules-Cards-card-anatomy.png" width="400" />
  ...
  export const myStory = () => <Button>Hello, World!</Button>myStory.story = {
    parameters: {
       design: {
          type: 'figma',
          url: 'https://www.figma.com/file/s7bDufypve1ibLCMTNiDpL/Radial-Storybook-Assets?node-id=488%3A1713'
       }
    }
 }
...
<Canvas>
    <Story name="Horizontal Small with Gallery Icon">
        {{
            components: { VCard },
            template: `
<v-card
...
<Canvas>
    <Story name="Vertical Large with Gallery Icon">
        {{
            components: { VCard },
            template: `
<v-card
