...
<br/>
 <img alt="tooltip closed state" src="/assets/images/Molecules-Tooltips-ClosedState.png" width="300" />
<br/>
...
<br/>
 <img alt="tooltip opened state" src="/assets/images/Molecules-Tooltips-OpenedState.png" width="300" />
<br/>
...
Tooltips can vary in their configuration or style by brand. This includes typography, color, padding, and the optional link button or primary CTA. See the examples below for Whitelabel (left) vs. Gothamist (right).
 <img alt="tooltip variations" src="/assets/images/Molecules-Tooltips-Variants.png" width="400" />
