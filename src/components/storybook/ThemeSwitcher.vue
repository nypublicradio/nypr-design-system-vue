...
import WhitelabelThemeWrapper from '../storybook/WhitelabelThemeWrapper'
import WnycThemeWrapper from '../storybook/WnycThemeWrapper'
import WqxrThemeWrapper from '../storybook/WqxrThemeWrapper'

export default {
  name: 'ThemeSwitcher',
  components: {
    VSpacer,
    GothamistThemeWrapper,
    WhitelabelThemeWrapper,
    WnycThemeWrapper,
    WqxrThemeWrapper
  },
  props: {
    theme: {
      type: String,
      default: 'whitelabel-theme-wrapper'
    }
  },
  data () {
    return {
