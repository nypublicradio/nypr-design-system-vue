<template>
  <div>
    ...
    <v-person
      ...
      animate
      name='Jen Chung'
      nameLink='https://gothamist.com/staff/jen-chung'
...
export default {
  ...
  components: {
    SecondaryNavigation: () => import('../components/SecondaryNavigation'),
    TheHeader: () => import('../components/TheHeader'),
    GothamistLogo: () => import('../components/icons/gothamist/GothamistLogo'),
